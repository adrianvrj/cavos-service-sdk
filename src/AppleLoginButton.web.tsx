...
export const SignInWithApple: React.FC<AppleLoginButtonProps> = ({
  ...
  return (
    <button
      type="button"
      onClick={handleLogin}
      className="flex items-center justify-center gap-2 px-6 py-3 bg-black text-white font-medium text-sm rounded-lg hover:bg-gray-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 min-w-[200px]"
    >
      <AppleIcon />
